...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="<?= $this->include('public/assets/images/favicon.png.base64'); ?>" />
    ...
    <body>
        ...
        <?php if (class_exists(\Symfony\Component\HttpKernel\Kernel::class)) { ?>
            <header>
                <div class="container">
                    <h1 class="logo"><?= $this->include('public/assets/images/symfony-logo.svg'); ?> Symfony Exception</h1>

                    <div class="help-link">
                        <a href="https://symfony.com/doc/<?= Symfony\Component\HttpKernel\Kernel::VERSION; ?>/index.html">
                            <span class="icon"><?= $this->include('public/assets/images/icon-book.svg'); ?></span>
