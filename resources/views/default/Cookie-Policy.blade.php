...
@section('content')
    <section class="my-5">
        <div class="General-Terms">
            <div class="container">
                <div class="General-Terms-content">
                    <h2>Cookie Policy for IAtify</h2>
                    <small>Last updated on June 28, 2024</small>
                    <div class="left_line">
                        This Cookie Policy describes the policies of IAtify on the collection, use, and disclosure of your
                        information that we collect when you use our website (https://iatify.com/) (the “Service”). By
                        accessing or using the Service, you are consenting to the collection, use, and disclosure of your
                        information in accordance with this Cookie Policy. If you do not consent to the same, please do not
                        access or use the Service.
                        <br><br>
                        We may modify this Cookie Policy at any time without any prior notice to you and will post the
                        revised Cookie Policy on the Service. The revised Policy will be effective 180 days from when the
                        revised Policy is posted on the Service, and your continued access or use of the Service after such
                        time will constitute your acceptance of the revised Cookie Policy. We therefore recommend that you
                        periodically review this page.
                    </div>
                </div>
            </div>
        </div>
        <div class="Contribution-Licence">
            <div class="container">
                <div class="Contribution-Licence-content">
        ...
        <div class="Guidelines-Review">
            <div class="container">
                <div class="Guidelines-Review-content">
        ...
        <div class="Cookies-We-Set">
            <div class="container">
                <div class="Cookies-We-Set-content">
                    <h2>The Cookies We Set</h2>
                    <span>
                        <ul>
                            <span>Account related cookies</span>
                            <li>If you create an account with us then we will use cookies for the management of the signup
                            ...
                            <li>We use cookies when you are logged in so that we can remember this fact. This prevents you
                                ...
                                and areas when logged in.</li>
                            <span>Email newsletters related cookies</span>
                            <li>This site offers newsletter or email subscription services and cookies may be used to
                                remember if you are already registered and whether to show certain notifications which might
                                only be valid to subscribed/unsubscribed users.</li>
                            <span>Orders processing related cookies</span>
                            <li>This site offers e-commerce or payment facilities and some cookies are essential to ensure
                                that your order is remembered between pages so that we can process it properly.</li>
                            <span>Surveys related cookies</span>
                            <li>From time to time we offer user surveys and questionnaires to provide you with interesting
                                insights, helpful tools, or to understand our user base more accurately. These surveys may
                                use cookies to remember who has already taken part in a survey or to provide you with
                                accurate results after you change pages.</li>
                            <span>Forms related cookies</span>
                            <li>When you submit data to through a form such as those found on contact pages or comment forms
                                cookies may be set to remember your user details for future correspondence.</li>
                            <span>Site preferences cookies</span>
                            <li>In order to provide you with a great experience on this site we provide the functionality to
                                ...
                                interact with a page is affected by your preferences.</li>
                        </ul>
                    </span>
                </div>
            </div>
                ...
                <div class="Restrictions-content">
                    ...
                    <ul>
                        <li>
                            ...
                            and the pages that you visit so we can continue to produce engaging content. For more
                            information on Google Analytics cookies, see the official Google Analytics page.
                        </li>
                        <li>From time to time we test new features and make subtle changes to the way that the site is
                            ...
                            optimisations our users appreciate the most.</li>
                        <li>As we sell products it's important for us to understand statistics about how many of the
                            ...
                            possible price.</li>
                        <li>Several partners advertise on our behalf and affiliate tracking cookies simply allow us to see
                            ...
                            they may provide you for making a purchase.</li>
                        <li>We also use social media buttons and/or plugins on this site that allow you to connect with your
                            ...
                            {List the social networks whose features you have integrated with your site?:12}, will set
                            cookies through our site which may be used to enhance your profile on their site or contribute
                            to the data they hold for various purposes outlined in their respective privacy policies.</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="Restrictions">
            <div class="container">
                <div class="Restrictions-content">
                    ...
                    <p>
                        For more general information on cookies, please read <a href="#">the Cookies Policy
                            article.</a>
                    </p>
                    ...
                    <ul>
                        <li>
                            Email : contact@iatify.com
                        </li>
                        <li>By visiting this link : page contact</li>
                    </ul>
                </div>
            </div>
        </div>
