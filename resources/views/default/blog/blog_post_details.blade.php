            ...
            <div class="row row-cols-lg-2 row-cols-md-1 row-cols-sm-1 row-cols-1">
                <div class="col">
                    ...
                    <div class="Navigating_profile">
                        <img src="assets/images/images/Navigating_profile.png" alt="">
                        <span>@lang("messages.Leslie Alexander")</span>
                    </div>
                </div>
                <div class="col">
                    <div class="Navigating_image">
                        <img src="assets/images/images/Navigating_image.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="blog-detils-content">
                <div class="blog_content">
                    ...
                    <img src="assets/images/images/blogs_detils.png" alt="">
                    ...
                    <img src="assets/images/images/Business.png" alt="">
      ...
      <div class="row row-cols-lg-4 row-cols-md-2 row-cols-sm-1 row-cols-1">
        <div class="col my-3">
          <div class="Related-posts-image">
            <img src="assets/images/images/Related-img1.png" alt="Related-image">
        ...
        <div class="col my-3">
          <div class="Related-posts-image">
            <img src="assets/images/images/Related-img-2.png" alt="Related-image">
            <div class="Related-posts-content">
              <div class="Report">
                <span>@lang("messages.Report")</span>
              </div>
        ...
        <div class="col my-3">
          <div class="Related-posts-image">
            <img src="assets/images/images/Related-img3.png" alt="Related-image">
            <div class="Related-posts-content">
              <div class="Report">
                <span>@lang("messages.Report")</span>
              </div>
        ...
        <div class="col my-3">
          <div class="Related-posts-image">
            <img src="assets/images/images/Related-img4.png" alt="Related-image">
          </div>
          <div class="Related-posts-content">
            <div class="Report">
              <span>@lang("messages.Report")</span>
